...
+ (UIView*)addTabbarButtonTitle:(NSArray*)titleList
                    buttonArray:(NSMutableArray*)buttonArray
                         target:(id)target
                         action:(SEL)action{
    
    NSInteger searchBarHight = 64;
    CGRect frm = [UIScreen mainScreen].bounds;
    
    NSInteger count = titleList.count;
    UIColor * lineColor=RGBCOLOR(200, 200, 200);

    UIView *  titleButtonView=[[UIView alloc] initWithFrame:CGRectMake(0, searchBarHight, frm.size.width, 45)];
    
    titleButtonView.backgroundColor = [UIColor whiteColor];
    
    UILabel * lineTop=[ViewCreatorHelper createLabelWithTitle:nil font:[UIFont systemFontOfSize:10.0f] frame:CGRectMake(0, 0, frm.size.width, 0.5) textColor:[UIColor blackColor] textAlignment:0];
    lineTop.backgroundColor=lineColor;
    [titleButtonView addSubview:lineTop];
    
    UILabel * linesdottm=[ViewCreatorHelper createLabelWithTitle:nil font:[UIFont systemFontOfSize:10.0f] frame:CGRectMake(0, 45.5, frm.size.width, 0.5) textColor:[UIColor blackColor] textAlignment:0];
    linesdottm.backgroundColor=lineColor;
    [titleButtonView addSubview:linesdottm];
    
    CGFloat buttonWidth =frm.size.width/count;
    for (int i=0; i<count; i++) {
        
        CGRect rc=CGRectMake(0, 0.5, buttonWidth, 45);
        rc.origin.x=i*(frm.size.width/count);
        NSString * str=titleList[i];
        UIButton * button=[ViewCreatorHelper createButtonWithTitle:nil frame:rc color:RGBCOLOR(255, 255, 255) hlColor:lineColor target:target action:action];
        [button setBackgroundImage:[UIImage imageWithColor:RGBCOLOR(237, 237, 237) size:rc.size] forState:UIControlStateSelected];
        button.tag=i;
        [titleButtonView addSubview:button];
        
        UILabel * lable=[ViewCreatorHelper createLabelWithTitle:str font:[UIFont systemFontOfSize:15.0f] frame:rc textColor:RGBCOLOR(31, 31, 31) textAlignment:NSTextAlignmentCenter];
        [titleButtonView addSubview:lable];
    ...
    CGRect rc=CGRectMake(1*(frm.size.width/count)-0.5, 0.5, 0.5,45);
    UILabel * linesLa=[ViewCreatorHelper createLabelWithTitle:nil font:[UIFont systemFontOfSize:10.0f] frame:rc textColor:[UIColor blackColor] textAlignment:0];
    linesLa.backgroundColor=lineColor;
    [titleButtonView addSubview:linesLa];
    [titleButtonView bringSubviewToFront:linesLa];
    
    rc.origin.x=2*(frm.size.width/count)-0.5;
    UILabel * linesrigth=[ViewCreatorHelper createLabelWithTitle:nil font:[UIFont systemFontOfSize:10.0f] frame:rc textColor:[UIColor blackColor] textAlignment:0];
    linesrigth.backgroundColor=lineColor;
    [titleButtonView addSubview:linesrigth];
    [titleButtonView bringSubviewToFront:linesrigth];
    
    rc.origin.x=3*(frm.size.width/count)-0.5;
    UILabel * linesrigth3=[ViewCreatorHelper createLabelWithTitle:nil font:[UIFont systemFontOfSize:10.0f] frame:rc textColor:[UIColor blackColor] textAlignment:0];
    linesrigth3.backgroundColor=lineColor;
    [titleButtonView addSubview:linesrigth3];
    [titleButtonView bringSubviewToFront:linesrigth3];
